        ...
        public string EvaluateGrade(int grade, string name, int wrongForPlus, int wrongForMinus)
        {
            ...
            try
            {
                if (grade == 100)
                {
                    ...
                    finalGrade.APlus.Visibility = Visibility.Visible;
                    return $"Perfect score! Good job {name}!";
                }
                else if (grade >= 80 && grade < 100)
                {
                    finalGrade.Excelent.Play();
                    finalGrade.AMinus.Visibility = Visibility.Visible;
                ...
                else if (grade > 55 && grade < 80)
                {
                    ...
                    finalGrade.B.Visibility = Visibility.Visible;
                ...
                else
                {
                    ...
                    finalGrade.F.Visibility = Visibility.Visible;
