    ...
    internal class GameLogic
    {
       ...
       // private int onFire;
        ...
        public GameLogic(EnterGame enterGame, int NumberOfTargilim, int SumGrade, int timeRemaining, int WrongForMinus, int WrongForPlus)
        {
            ...
            enterGame.Clock.MediaEnded += Clock_MediaEnded;



        }

        private void Clock_MediaEnded(object sender, EventArgs e)
        {
            // Restart the audio playback when it ends
            enterGame.Clock.Position = TimeSpan.Zero;
            enterGame.Clock.Play();
        }
        ...
        {
            timeRemaining = 30;
            enterGame.Timer.Text = $"{timeRemaining} seconds";
